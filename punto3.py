...
while(opcion!=0):
    print()
    print()
    print("1. Digitar 1 para recibir {código, nombre, precio} de un producto (+0.4)")
    print("2. Digitar 2 para mostrar todos los productos registrados (+0.4)")
    print("3. Digitar 3 para permitir buscar por código un producto y editar el preciode este (+0.4)")
    print("4. Digitar 4 para permitir buscar por código un producto y eliminar elproducto (+0.4)")
